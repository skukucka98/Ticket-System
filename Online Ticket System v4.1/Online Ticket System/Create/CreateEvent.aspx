...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <table>
        <tr>
            ...
            <th id="CenterContent">
                <div id="CEContent">
                    <div style="background-color: lightyellow; font-size: 40px;">CREATE NEW EVENT</div>
                    <div>
                        <table class="ticketTable">
                            <tr>
                                <td style="width: 81px">Name:</td>
                            ...
                            <tr>
                                <td class="auto-style1">Seat level:</td>
                                <td class="auto-style2" style="text-align: left">
                                    <div>
                            ...
                            <tr>
                                <td style="width: 81px">Status:<br />
                                    (Available)</td>
                                <td style="width: 495px; text-align: left">

                                    <asp:TextBox ID="txtEventStatus" runat="server" Width="300px" ValidationGroup="AddEvent" CssClass="CrBox"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEventStatus" ErrorMessage="*" ValidationGroup="AddEvent" ForeColor="Red"></asp:RequiredFieldValidator>

                                </td>
                            </tr>
                            <tr>
                                <td style="width: 81px">Category ID:</td>
                                <td style="width: 495px; text-align: left">
                            ...
                            <tr>
                                <td style="width: 81px">Description:</td>
                                <td style="width: 495px; text-align: left">
                        ...
                        <div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="EventID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="539px">
