                            ...
                            <tr>
                                ...
                                <td style="width: 495px">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtSeatSection" runat="server" Width="109px" ValidationGroup="AddSSection" CssClass="CRVBox" TextMode="Number" title="Add Section Number" style="text-align: center"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTotalSeat" runat="server" Width="109px" ValidationGroup="AddSSection" CssClass="CrSmalBox" TextMode="Number" title="Add Total Seats"></asp:TextBox>
                            ...
                            <div style="height: 500px; overflow: auto">
                                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="VenueID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:CommandField ButtonType="Button" HeaderText="View" ShowHeader="True" ShowSelectButton="True" SelectText="Detail" />
                                    </Columns>
                        ...
                        <div id="Vdetail" runat="server">
                            ...
                            <asp:DetailsView ID="VenDetail" runat="server" Height="50px" Width="694px" AutoGenerateRows="False" DataSourceID="SqlDataSource2" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" DataKeyNames="VenueID" OnItemUpdated="VenDetail_ItemUpdated" OnItemDeleted="VenDetail_ItemDeleted">
                                ...
                                <Fields>
                                    ...
                                    <asp:TemplateField HeaderText="Venue Info">
                                        <EditItemTemplate>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="EditSeatSection" runat="server" CssClass="CRVBox" TextMode="Number" ValidationGroup="EditAddSSection" Width="109px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="EditSeatSection" ErrorMessage="*" ForeColor="Red" ValidationGroup="EditAddSSection"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="EditTotalSeat" runat="server" CssClass="CrSmalBox" TextMode="Number" ValidationGroup="EditAddSSection" Width="109px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="EditTotalSeat" ErrorMessage="*" ForeColor="Red" ValidationGroup="AddSSection"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="EditAddSeat" runat="server" CssClass="CRVButt" Height="35px" Text="Add" ValidationGroup="EditAddSSection" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                </tr>
                                            ...
                                            <br />
                                            <asp:GridView ID="VeninfoDetail" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource3" CellPadding="4" ForeColor="#333333" GridLines="None" Width="300px">
                                    ...
                                    <asp:BoundField DataField="SeatDiagram" HeaderText="SeatDiagram" SortExpression="SeatDiagram" />
