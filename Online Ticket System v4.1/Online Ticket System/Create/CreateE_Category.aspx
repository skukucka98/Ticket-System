    ...
    <div id="Content">
        <table>
            <tr>
                ...
                <th id="CenterContent">
                    <div id="E_CatContent">
                        <div style="background-color: lightyellow; font-size: 40px;">CREATE NEW CATEGORY</div>
                        <div id="C_sub">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <div style="width:720px;height: 500px; overflow: auto;">
                                            <asp:GridView ID="CateGrid" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="CateGridDataSource" GridLines="None" Width="700px" ValidationGroup="SCat" DataKeyNames="EventCategoryid" PageSize="5" OnRowCommand="CateGrid_RowCommand" OnRowUpdating="CateGrid_RowUpdating" ForeColor="#333333">
