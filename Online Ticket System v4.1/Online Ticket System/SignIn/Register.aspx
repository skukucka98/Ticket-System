                            ...
                            <td id="RegisterInfo">
                                <table>
                                    <tr id="reg10">
                                        ...
                                        <td>
                                            <div style="margin-bottom: 1px;">
                                                <asp:TextBox ID="UsernameReg" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Username"></asp:TextBox>
                                    ...
                                    <tr id="reg11">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="PasswordReg" runat="server" CssClass="RegBox" TextMode="Password" ValidationGroup="RegisterGroup" title="Password"></asp:TextBox>
                                    ...
                                    <tr id="reg12">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="ReEnterPasswordBox" runat="server" CssClass="RegBox" TextMode="Password" ValidationGroup="RegisterGroup" title="Re-Enter Password"></asp:TextBox>
                                    ...
                                    <tr id="reg1">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="FirstnameBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="First Name"></asp:TextBox>
                                    ...
                                    <tr id="reg2">
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <asp:TextBox ID="LastnameBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Last Name"></asp:TextBox>
                                    ...
                                    <tr id="reg3">
                                        <td id="id8">Address 1:</td>
                                        <td>
                                            <div>
                                                <asp:TextBox ID="Address1Box" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Address 1"></asp:TextBox>
                                    ...
                                    <tr id="reg4">
                                        <td id="id9">Address 2:</td>
                                        <td>
                                            <div>
                                                <asp:TextBox ID="Address2Box" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Address 2"></asp:TextBox>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr id="reg5">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="CityBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="City"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="CityValidator" runat="server" ErrorMessage="*" ControlToValidate="CityBox" ForeColor="#FF0066" ValidationGroup="RegisterGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr id="reg6">
                                        ...
                                        <td>
                                            <div>
                                                <asp:DropDownList ID="StateBox" runat="server" CssClass="RegDRList" title="State">
                                    ...
                                    <tr id="reg7">
                                        <td id="id12">Zip Code:</td>
                                        <td>
                                            <div>
                                                <asp:TextBox ID="ZipcodeBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Zid Code"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="ZipcodeValidator" runat="server" ErrorMessage="*" ControlToValidate="ZipcodeBox" ForeColor="#FF0066" ValidationGroup="RegisterGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr id="reg8">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="PhoneBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Phone Number"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="PhoneValidator" runat="server" ErrorMessage="*" ControlToValidate="PhoneBox" ForeColor="#FF0066" ValidationGroup="RegisterGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr id="reg9">
                                        ...
                                        <td>
                                            <div>
                                                <asp:TextBox ID="EmailBox" runat="server" CssClass="RegBox" ValidationGroup="RegisterGroup" title="Email"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="EmailValidator" runat="server" ErrorMessage="*" ControlToValidate="EmailBox" ForeColor="#FF0066" ValidationGroup="RegisterGroup"></asp:RequiredFieldValidator>
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
