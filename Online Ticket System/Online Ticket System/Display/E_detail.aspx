...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td id="CenterContent">
                ...
                <div>
                    ...
                    <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Font-Bold="True" BorderColor="#999999" CssClass="MyTabStyle">
                        <cc1:TabPanel runat="server" HeaderText="Find Your Seat" ID="FindUrSeat">
                            <ContentTemplate>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <div style="background-color:#eae6eb">
                                            <table style="width:500px; margin-left:auto;margin-right:auto">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="QtyList" runat="server"  CssClass="btnstandard" Height="35px" Width="50px"  style="margin-bottom:20px">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="PriceList" runat="server" DataSourceID="SqlDataSource1" DataTextField="Price" DataValueField="Price" AppendDataBoundItems="True"  CssClass="btnstandard" Height="35px" Width="100px"  style="margin-bottom:20px">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="SectionList" runat="server" DataSourceID="SqlDataSource2" DataTextField="SeatCategoryNumber" DataValueField="SeatCategoryNumber" AppendDataBoundItems="True" CssClass="btnstandard" Height="35px" Width="100px"  style="margin-bottom:20px">
                                                    ...
                                                    <td>
                                                        <asp:Button ID="TicketSer" runat="server" Text="Find Ticket" OnClick="TicketSer_Click" CssClass="btnstandard" Height="35px" Width="110px" Font-Bold="true" ForeColor="White" BackColor="Red"  style="margin-bottom:20px"/></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="height: 400px; width: 220px; overflow: Auto">
                                                            <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333" DataKeyField="SeatID">
                                                                ...
                                                                <ItemTemplate>
                                                                    <table class="auto-style1">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3">
                                                                                <asp:CheckBox ID="chked_item" runat="server" Text="Add to Cart" /></td>
                                                                        </tr>
                                                                    </table>
                                                                </ItemTemplate>
                                                    ...
                                                    <td style="vertical-align: text-top" class="auto-style3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <cc1:ModalPopupExtender ID="modalPopup" runat="server" TargetControlID="ImageButton" PopupControlID="Panel1" BackgroundCssClass="jsMpeBackground" OkControlID="Button1" BehaviorID="modalPopup" Enabled="True"></cc1:ModalPopupExtender>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="Buybtn" runat="server" Text="Buy Ticket" Height="40px" Width="110px" BackColor="Blue" ForeColor="White" Font-Bold="true" CssClass="btnstandard" OnClick="Buybtn_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="Popup" Style="display: none">
        <div id="seatimage">
            <div style="position: absolute;text-align:right; right:20px; top:10px">
                <asp:Button ID="Button1" runat="server" Text="X" CssClass="lbl"/>
            </div>
            <div>
                <asp:Image ID="Image1" runat="server" Height="500px" Width="600px" ImageUrl="~/Images/seat diagram.jpg" />
            </div>
        </div>
    </asp:Panel>
</asp:Content>
