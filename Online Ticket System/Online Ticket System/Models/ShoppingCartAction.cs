...
namespace Online_Ticket_System.Models
{
    public class ShoppingCartAction : IDisposable
    {
        ...
        public decimal GetTotal()
        {
            ...
            // Sum all product prize totals to get the cart total
        ...
        {
            using (var db = new Online_Ticket_System.Models.ProductContext())
            {
                try
                {
        ...
        {
            using (var _db = new Online_Ticket_System.Models.ProductContext())
            {
                try
                {
