                ...
                <th id="CenterContent" style="width:900px">
                    ...
                    <div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="UpcomeE" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderWidth="3px" CellPadding="4" DataKeyNames="eventid" GridLines="Horizontal" BorderStyle="Double">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="eventid" DataNavigateUrlFormatString="~/Display/E_detail.aspx?id={0}" DataTextField="eventname" HeaderText="Events" SortExpression="eventname" ItemStyle-Width="250px" ControlStyle-Font-Underline="false" ControlStyle-ForeColor="Black">
